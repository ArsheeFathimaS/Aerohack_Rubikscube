# ################ A simple graphical interface for the Rubik's cube solver #####################################
...
def solve():
    ...
    # Call the solver with a reasonable timeout
    solution = sv.solve(defstr, 20, 2)
    show_text('Solution: ' + solution + '\n')
########################################################################################################################
...
root = Tk()
root.wm_title("Rubik's Cube Solver")
